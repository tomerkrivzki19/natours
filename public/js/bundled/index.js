...
if (createTourFormSeconed) createTourFormSeconed.addEventListener("submit", (e)=>{
    ...
    // Append startDates
    formData.append("startDates[0]", getFormElementValue('input[name="startDates[0]"]'));
    formData.append("startDates[1]", getFormElementValue('input[name="startDates[1]"]'));
    formData.append("startDates[2]", getFormElementValue('input[name="startDates[2]"]'));
    // Append guides
